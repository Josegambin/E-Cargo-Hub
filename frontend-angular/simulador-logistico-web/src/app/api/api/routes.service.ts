...
export class RoutesService extends BaseService implements RoutesServiceInterface {
    ...
    public createRoute(createRouteRequest: CreateRouteRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Route>>;
    public createRoute(createRouteRequest: CreateRouteRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (createRouteRequest === null || createRouteRequest === undefined) {
            throw new Error('Required parameter createRouteRequest was null or undefined when calling createRoute.');
        }
    ...
    public getRoutes(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<Route>>>;
    public getRoutes(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
