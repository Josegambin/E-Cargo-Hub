...
public class ApiError {
   ...
   */
  @NotNull 
  @Schema(name = "error", example = "NOT_FOUND", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("error")
   ...
   */
  @NotNull 
  @Schema(name = "message", example = "Vehicle not found", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   */
  @NotNull 
  @Schema(name = "path", example = "/api/vehicles/10", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("path")
